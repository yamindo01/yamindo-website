...
const ENTITY_FIELDS: Record<string, FieldDef[]> = {
  "hero-slides": [
    ...
    { key: "bullets", label: "Bullet Points (JSON array)", type: "text" },
  ...
  "footer-events": [
    { key: "date", label: "Tanggal", type: "text" },
    { key: "title", label: "Judul Acara", type: "text" },
    { key: "active", label: "Aktif", type: "checkbox" },
  ],
  "donation-presets": [
    { key: "label", label: "Label", type: "text" },
...
function SiteConfigManager() {
  ...
  const CONFIG_LABELS: Record<string, string> = {
    topbar_welcome: "Teks Top Bar",
    phone: "Nomor Telepon",
    email: "Email",
    address: "Alamat",
    cta_title: "Judul CTA Banner",
    cta_subtitle: "Subtitle CTA Banner",
  };
